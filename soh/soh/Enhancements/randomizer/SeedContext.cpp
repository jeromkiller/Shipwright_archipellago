...
void Context::ParseArchipelagoOptions() {
    ...
    mOptions[RSK_FROGS_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_OOT_HINT].Set(RO_GENERIC_YES);
    ...
    mOptions[RSK_MASK_SHOP_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_BIGGORON_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_BIG_POES_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_CHICKENS_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_MALON_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_HBA_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_WARP_SONG_HINTS].Set(RO_GENERIC_NO);
    mOptions[RSK_SCRUB_TEXT_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_MERCHANT_TEXT_HINT].Set(RO_GENERIC_YES);
    mOptions[RSK_FISHING_POLE_HINT].Set(RO_GENERIC_YES);
